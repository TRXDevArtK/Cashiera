<html>
    ...
    <body class="cnv-body-3">
        ...
        <section>
            ...
            <!--isi modal-->
                ...
                <div class="section">
                    <div class="modal-header-1">
                        ...
                        <!--notifikasi-->
                        <div class="center">
                            <p class="bold">Laporan Penjualan</p>
                            <p class="cnv-danger-1" id="notf-report"></p>
                        </div>
                    </div>
                        <div class="modal-body-1">
                            <label class='cnv-text-1' for='report-pricing'>Laporan Keuangan : </label>
                            <input type="text" class="inp-gen-txt-1" id="report-pricing" name="report-pricing" disabled><br>
                            <label class='cnv-text-1' for='report-desc'>Deskripsi : </label>
                            <input type="text" class="inp-gen-txt-1" id="report-desc" name="report-desc" disabled><br>
                        </div>
            ...
            <table style="width:100%;" class="table-horizon-scroll block" id="selling-table">
                <thead id="thead">
                </thead>
                <tbody id="tbody">
                    <!--table data-->
        ...
        <script>
            ...
            $(document).ready(function(){
                ...
                function read_selling_history(paging_num, paging, limit){
                        ...
                        success:function(data){
                            ...
                            if(data['data'] !== 'none' && data['data'] !== null){
                                ...
                                for(count; count < data_length; count++){
                                    ...
                                    if(data['data'][count]['Laporan'] != ""){
                                        html += "<tr class='cnv-warning-1'>";
                                    }
                                    else{
                                        html += "<tr>";
                                    }
...
\n\                                         <td class='-col-8'>"+data['data'][count][tableHeaderData[11]]+"</td>\n\
                                            <td class='-col-9'><button id='modal-btn-1' data-value='"+data['data'][count]['Laporan Keuangan']+"' data-desc='"+data['data'][count]['Laporan']+"'>Laporan</button></td>\n\
                                        </tr>";
                ...
                $("#limit").on("change", function(){
                    var val = $(this).val();
                    read_selling_history(null, true, val);
                });
                ...
                $(document).on('click', '.paging, #apply-filter, #search-submit', function(){
                    ...
                    read_selling_history(currPaging, true, val);
                });
                ...
                function get_list_table_header(data, length){
                    if(data['data'] !== 'none' && data['data'] !== null){
                        var html = '';
                        var count = 0;
                        var decrease = 2;// decrease no need table
